...
import { HeaderUi, HeaderSearcher, MenuOverlay, MenuItem, UserEmail, LogoutButton, UserPhone } from "@/ui/layout";
...
return (
    <>
      <HeaderUi 
        ...
        {menuOpen && (
          <MenuOverlay>
            <MenuItem href="/home" onClick={() => handleMenuItemClick("/home")}>Home</MenuItem>
            <MenuItem href="/MisReportes" onClick={() => handleMenuItemClick("/MisReportes")}>Mis Reportes</MenuItem>
          <div style={{display:"flex", flexDirection: "column", marginTop: "20px"}}>
            <UserEmail>{data.owner.email}</UserEmail> {/* Muestra el email del usuario */}
            <UserPhone>{data.owner.telephone}</UserPhone> {/* Muestra el telefono del usuario */}
